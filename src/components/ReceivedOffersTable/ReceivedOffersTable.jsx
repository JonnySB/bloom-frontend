...
const ReceivedOffersTable = ({ receivedOffers }) => {
            ...
            {receivedOffers?.map((help_offer) => {
                return (
                    <tr key={help_offer.help_offer_id}>
                        ...
                        <th><AcceptButton help_offer_id={help_offer.help_offer_id}/></th>
                        <th><RejectButton help_offer_id={help_offer.help_offer_id}/></th>
